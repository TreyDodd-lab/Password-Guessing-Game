...
You have 2 minutes total before the headmaster “returns”

Guess the password correctly to win
...
Click the Run button (the green ▶ at the top)

Visual Studio will compile and run the program automatically
...
Structuring a small console game
